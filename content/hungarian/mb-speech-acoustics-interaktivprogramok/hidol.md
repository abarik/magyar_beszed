---
title: "HIDOL"
subtitle: "Beszédhang-időtartam mérő program"
# meta description
description: "Beszédhang-időtartam mérő program"
draft: false
layout: "how-it-works"
...
######################### how it works banner #####################
banner:
  title: "HIDOL (Beszédhang-időtartam mérő program)"
  image: "images/mb-speech-acoustics/hidol.png"
  content:  "A HIDOL program magyar nyelven felolvasott mondatokból (saját adatbázis) a beszédhang-időtartamok és a szóhosszak adatainak feldolgozására szolgál (átlagok, eloszlások, összehasonlítások, tendenciák). Az eredményeket txt kiterjesztésű tabulátorral tagolt fájlokban adja meg. A programmal a folyamatos beszéd hangidőtartamai határozhatók meg gyors méréssel.<br>
