...
$(document).ready(function () {
	...
	$('.video-play-btn-loc').on('click', function () {
		var thumbWidth = $(this).siblings('.video-thumb').width();
		var video = '<div class="ratio ratio-16x9 mx-auto bg-dark rounded-2 overflow-hidden" style="max-width:'+ thumbWidth +'px"><video controls autoplay><source src="' + $(this).data('src') + '" type="video/mp4"></video> ';
		$(this).fadeOut(100);
		$(this).siblings('.video-thumb').replaceWith(video);
	});	
	// counterUp
